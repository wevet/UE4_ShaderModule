...
void USketchComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	USketchComponent* This = this;
	FTextureRenderTargetResource* RenderTargetResource = RenderTexture->GameThread_GetRenderTargetResource();

	ENQUEUE_RENDER_COMMAND(FRaymarchingPostprocess)([This, RenderTargetResource](FRHICommandListImmediate& RHICmdList)
	{
